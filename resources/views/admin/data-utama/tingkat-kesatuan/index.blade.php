...
<div class="space-y-6 pb-20 font-sans" style="font-family: 'Ramabhadra', sans-serif;">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 px-2 mb-8 transition-all duration-500 animate-in fade-in slide-in-from-top-4">
        <div>
            ...
            {{-- Main Title: text-3xl (Static) sesuai patokan Jabatan --}}
    ...
    {{-- ==============================================================================
         2. SUMMARY STATS (Sikron & Lebih Padat) - UI ASLI PERTAHANKAN
         ============================================================================== --}}
    ...
    {{-- ==============================================================================
         3. HIERARCHICAL TABLE (Premium Tree View) - UI ASLI PERTAHANKAN
         ============================================================================== --}}
    <div class="bg-white/80 backdrop-blur-xl rounded-[2.2rem] border border-white shadow-2xl shadow-slate-200/40 overflow-hidden">
        <div class="grid grid-cols-12 bg-slate-900/[0.02] border-b border-slate-100">
            <div class="col-span-8 px-10 py-5 text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]">Struktur Kesatuan & Personel Komando</div>
            <div class="col-span-4 px-10 py-5 text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] text-right">Wilayah Administratif</div>
        </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="flex flex-wrap items-center gap-x-4 text-[9px] font-bold uppercase tracking-widest text-slate-400">
                                    <span class="flex items-center gap-1.5 bg-white px-2 py-0.5 rounded-lg border border-slate-100">
                                        <span class="text-slate-300 italic">KAPOLRES:</span> <span class="text-slate-700">{{ $polres['kapolres'] }}</span>
                                    </span>
                ...
                <div x-show="expanded" x-collapse>
                    <div class="relative bg-slate-50/40">
                        ...
                        @foreach($polres['polsek'] as $polsek)
                            <div class="grid grid-cols-12 items-center border-t border-white/60 hover:bg-white transition-all duration-300 group/child">
