...
<div class="space-y-8 pb-20 antialiased text-slate-900" style="font-family: 'Inter', system-ui, -apple-system, sans-serif;">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 px-4 transition-all duration-700 animate-in fade-in slide-in-from-top-4">
        <div>
            <nav class="flex items-center gap-2 text-xs font-medium text-slate-500 mb-1">
                ...
                <svg class="w-3 h-3 opacity-30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                <span class="text-emerald-600">Data Produksi Lahan</span>
            </nav>
            <h2 class="text-2xl lg:text-3xl font-semibold tracking-tight text-slate-900">
                Data <span class="text-slate-400 font-normal">Kelola Lahan</span>
            </h2>
        </div>

        <div class="flex flex-wrap items-center gap-3">
            {{-- Refined Search Component --}}
            ...
            <div class="flex items-center gap-2">
                ...
                <button class="flex items-center gap-2 px-5 py-2.5 bg-slate-900 text-white rounded-xl hover:bg-emerald-600 transition-all active:scale-95 text-sm font-medium shadow-md">
    ...
    <div class="px-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden group hover:border-slate-300 transition-all">
            <div class="p-6">
                <p class="text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-1">{{ $card['title'] }}</p>
    ...
    <div class="mx-4 bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        <div class="p-5 border-b border-slate-100 flex items-center justify-between">
            ...
            <span class="px-2 py-1 bg-slate-100 text-slate-500 text-[10px] font-bold rounded uppercase">Auto-Refresh: ON</span>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50 text-[11px] font-semibold text-slate-500 uppercase tracking-widest border-b border-slate-100">
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    ...
                    <tr class="group hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-8 py-5 text-center">
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-100 uppercase tracking-wider">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                                Proses Tanam
                            </span>
                        </td>
                        <td class="px-8 py-5 text-center font-medium text-slate-700">12.50 <span class="text-slate-300">Ha</span></td>
                        <td class="px-8 py-5">
