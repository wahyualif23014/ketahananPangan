    ...
    <script>
        function kelolaLahan() {
            return {
                ...
                async submitPanen() {
                    // VIEW role — read-only, tidak ada aksi write
                    alert('Mode Lihat: Input panen tidak tersedia untuk role ini.');
                    return;
                    try {
                        const url = this.isEditMode ? `/view/kelola-lahan/panen/${this.activeProcessId}` : '#';
                ...
                async submitSerapan() {
                    // VIEW role — read-only, tidak ada aksi write
                    alert('Mode Lihat: Input serapan tidak tersedia untuk role ini.');
                    return;
                }
            };
        }
