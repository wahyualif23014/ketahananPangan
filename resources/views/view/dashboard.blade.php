...
@section('header', 'Dashboard Utama View')
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-5 transition-all duration-700 animate-in fade-in slide-in-from-top-8">
        <div>
            <nav class="flex items-center gap-2 font-black tracking-[0.2em] uppercase text-slate-400 mb-2">
                <span class="text-[10px] border-b-2 border-slate-300 pb-0.5">VIEW AREA</span>
        ...
        <div class="lg:col-span-2 bg-white/90 backdrop-blur rounded-[2rem] border border-slate-200/60 shadow-xl p-6 md:p-8 relative overflow-hidden">
            ...
            <div class="flex flex-wrap items-start justify-between gap-4 mb-6 relative z-10">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    {{-- Filter Tahun Chart --}}
                    <form method="GET" action="{{ route('view.dashboard') }}" id="chart-filter-form" class="flex items-center gap-2">
        ...
        <div class="px-8 py-6 border-b border-slate-800 flex items-center justify-between relative z-10">
            ...
            <div class="hidden md:flex flex-col items-end gap-1">
                <div class="flex items-center gap-2 px-3 py-1.5 bg-amber-500/10 border border-amber-500/30 rounded-xl">
                    ...
                    <span class="text-[10px] font-black text-amber-400 uppercase tracking-widest">{{ number_format(count($pendingPotensi) + count($pendingKelola)) }} Data Pending</span>
                </div>
                ...
                <div class="max-h-[300px] overflow-y-auto custom-scrollbar pr-2">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-800/50">
                            ...
                            <tr class="hover:bg-white/[0.02] transition-colors group cursor-pointer" onclick="window.location.href='{{ route('view.kelola-lahan.potensi.index', ['search' => $item->id_lahan]) }}'">
                ...
                <div class="max-h-[300px] overflow-y-auto custom-scrollbar pr-2">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-800/50">
                            ...
                            <tr class="hover:bg-white/[0.02] transition-colors group cursor-pointer" onclick="window.location.href='{{ route('view.kelola-lahan.index', ['search' => $item->id_lahan]) }}'">
