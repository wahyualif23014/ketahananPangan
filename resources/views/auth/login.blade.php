        ...
        <div class="relative z-10 w-full max-w-[720px] flex flex-col md:flex-row bg-white rounded-[2rem] shadow-[0_20px_60px_rgba(0,0,0,0.1)] overflow-hidden m-4 border border-slate-200">
            ...
            <div class="w-full md:w-[55%] p-6 md:p-10 flex flex-col justify-center bg-white">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div class="space-y-1">
                        <label for="nrp" class="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-1">NRP (Nomor Registrasi Pokok)</label>
                        <input id="nrp" type="text" name="nrp" :value="old('nrp')" required autofocus 
                        ...
                        <x-input-error :messages="$errors->get('nrp')" class="mt-1 text-[9px]" />
                    </div>
