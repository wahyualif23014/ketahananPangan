...
<div class="space-y-8 pb-24 rekapitulasi-container max-w-7xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-5 px-4 mb-2 transition-all duration-700 animate-in fade-in slide-in-from-top-8">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <form action="{{ route('operator.rekapitulasi.index') }}" method="GET" id="form-filter" class="flex items-center gap-2">
                ...
                <button type="button"
                    ...
                    <div x-show="showExportModal"
                        ...
                        <div @click.away="showExportModal = false"
                            ...
                            <form action="{{ route('operator.rekapitulasi.export') }}" method="GET" @submit="showExportModal = false">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-4" x-data="{
                    ...
                    async fetchPolsek(polresId) {
                        ...
                        try {
                            const res = await fetch(`{{ route('operator.rekapitulasi.polsek') }}?polres=${encodeURIComponent(polresId)}`, {
