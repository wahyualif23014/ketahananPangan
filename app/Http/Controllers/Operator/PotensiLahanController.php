...
class PotensiLahanController extends Controller {
    public function index(Request $request) {
        ...
        return view('operator.kelola-lahan.operator_potensi.operator_kelola_index', compact('summary', 'cats', 'lahanList', 'polresList', 'polsekList', 'kategoriMapping', 'komoditiList', 'kabupatenList', 'kecamatanList', 'desaList', 'anggotaList'));
    }
