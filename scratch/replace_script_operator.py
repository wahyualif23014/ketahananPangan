import re
with open('resources/views/operator/kelola-lahan/operator_kelola/operator_kelola_index.blade.php', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('resources/views/operator/kelola-lahan/operator_kelola/operator_kelola_index.blade.php', 'w', encoding='utf-8') as f:
    f.write(content)
